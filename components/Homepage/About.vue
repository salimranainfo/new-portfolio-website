<template>
  <div class="text-center flex flex-col justify-center items-center mb-16">
    ...
    <div class="max-w-[75rem] text-4E4E4E mt-20 space-y-4 text-xl tracking-wider leading-relaxed">
      ...
      <p>
        With a fervor for crafting elegant solutions, I navigate the ever-evolving landscape of software development. My
        journey involves translating concepts into code, creating seamless user experiences, and constantly pushing the
        boundaries of what's possible. As a passionate software engineer, I thrive on the intricate dance between logic
        and creativity. Currently immersed in the dynamic world of WebHR, my expertise centers around React Native,
